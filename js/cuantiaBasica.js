function cuantiaBasica(spd, minSalary=207.44){
    ...
    if (spd > toVSM(6)) {
    ...
    } else if (spd > toVSM(4.50)){
        factorCuantia = toFactorCuantia(17.30)
        incrementosAdicionales = toIncremetosAdicionales(2.330)
        ...
        incrementosAdicionales = toIncremetosAdicionales(1.430)
